...
const CreditForm = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/invoice/viewAll", {
        headers: {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      try {
        const response = await axios.post(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/creditNotes/create",
          apiData,
          {
            headers: {
