...
const CreditTable = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/creditNotes/viewall", {
        headers: {
    ...
    if (isConfirmed) {
      try {
        const response = await axios.delete(
          `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/creditNotes/${id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const uploadCSV = async () => {
    ...
    try {
      const response = await fetch(
        "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/creditNotes/creditnotes/import",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
