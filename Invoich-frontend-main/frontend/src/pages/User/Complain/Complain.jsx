...
export const Complain = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/usercomplain/getallcomplain"
      )
      .then((response) => {
  ...
  const handleSaveRequest = () => {
    if (newRequest.type && newRequest.title && newRequest.description) {
      if (isEditing && selectedRequest) {
        ...
        axios
          .put(
            `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/usercomplain/updatecomplain/${selectedRequest._id}`,
            `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/usercomplain/updatecomplain/${selectedRequest._id}`,
            {
              ...newRequest,
            }
        ...
        axios
          .post(
            "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/usercomplain/creatusercomplain",
            {
              ...newRequest,
              status: "pending",
              userId,
