...
const ManageSalespersonsPopup = ({ onClose }) => {
  ...
  const handleSave = async () => {
    ...
    if (name && email) {
      ...
      try {
        const response = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/salespersons/creatsalespersone",
          {
            method: "POST",
            headers: {
  ...
  const uploadCSV = async () => {
    ...
    try {
      const response = await fetch(
        "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/salespersons/salespersonecsv",
        {
          method: "POST",
          body: formData,
        }
