...
const InvoiceForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const customerResponse = await fetch("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/viewCustomers", {
        ...
        const itemResponse = await fetch("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/item/getallitem", {
        ...
        const salespersonResponse = await fetch("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/salespersons/getallsalespersone", {
          headers: { Authorization: `Bearer ${token}` },
        });
        ...
        if (id) {
          ...
          const invoiceResponse = await fetch(`https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/invoice/ViewById/${id}`, {
            headers: { Authorization: `Bearer ${token}` },
          });
  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint = id
      ? `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/invoice/updateById/${id}`
      : "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/invoice/create";
