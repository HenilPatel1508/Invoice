...
const ExpenseForm = () => {
      ...
      const fetchExpense = async () => {
        try {
          const response = await fetch(
            `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/expenses/expenses/${id}`,
            {
              method: "GET",
              headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = id
        ? `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/expenses/expenses/${id}`
        : "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/expenses/addexpenceimage";
