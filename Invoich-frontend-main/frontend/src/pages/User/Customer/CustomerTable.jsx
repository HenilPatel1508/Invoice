...
//         try {
//           const response = await fetch(
//             `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/deleteCustomer?id=${id}`,
//             {
//               method: "DELETE",
//               headers: {
//                 Authorization: `Bearer ${localStorage.getItem("token")}`, // Include token if needed
...
//     try {
//       const response = await fetch(
//         `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/viewCustomers/${_id}`
//       );
//       if (!response.ok) {
...
//     try {
//       const response = await fetch(
//         "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/Customercsv",
//         {
//           method: "POST",
//           body: formData,
//         }
