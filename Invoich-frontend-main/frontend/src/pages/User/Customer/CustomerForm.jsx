      ...
      if (id) {
        try {
          const response = await fetch(
            `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/viewCustomers/?id=${id}`,
            {
              headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      try {
        ...
        const apiUrl = id
          ? `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/updateCustomer?id=${id}`
          : "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/createCustomer";
