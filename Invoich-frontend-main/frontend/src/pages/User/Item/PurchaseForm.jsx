...
export const PurchaseForm = () => {
  ...
  useEffect(() => {
    fetch("https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/item/getallitem")
    ...
    if (id) {
      fetch(
        `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/purchaseInvoice/getsinglepurchaseinvoice/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      const apiUrl = id
        ? `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/purchaseInvoice/updatepurchaseinvoice/${id}`
        : "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/purchaseInvoice/creatpurchaseinvoice";
