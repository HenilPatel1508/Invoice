...
//           `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/business/getBusinessByID/${userId}`,
//           {
//             method: "GET",
//             headers: {
...
//     try {
//       const response = await fetch(
//         `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/business/updateBusiness/${userId}`,
//         {
//           method: "PUT",
//           headers: {
//             "Content-Type": "application/json",
