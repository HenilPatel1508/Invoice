    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        const businessResponse = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/business/registerBusiness",
          {
            method: "POST",
        ...
        const registerResponse = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/user/registerUser",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
