...
const SearchResults = ({ query }) => {
  ...
  useEffect(() => {
    const fetchCustomer = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/customer/viewCustomers",
          {
            headers: {
    ...
    const fetchCredit = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/creditNotes/viewall",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
    ...
    const fetchInvoice = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/invoice/viewAll",
          {
    ...
    const fetchPurchaseInvoice = async () => {
      try {
        const response = await fetch(
          `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/purchaseInvoice/getallpurchaseinvoice`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const fetchItem = async () => {
      try {
        const response = await fetch(
          `https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/item/getallitem`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const fetchExpenses = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend-dot-nuxhealth-449518.el.r.appspot.com/api/expenses/expenses",
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
